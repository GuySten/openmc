...
The limiter clips a region's gradient as needed so that the modeled source
stays non-negative over the region's bounding box, as sampled by the rays
that have crossed it, preserving the region's mean emission. The
