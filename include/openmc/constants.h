...
enum TallyScore {
  ...
  SCORE_IFP_EXT_SRC_NUM = -18,    // IFP external source numerator
  SCORE_IFP_TIME_NUM = -19,       // IFP lifetime numerator
  SCORE_IFP_BETA_NUM = -20,       // IFP delayed fraction numerator
  SCORE_IFP_DENOM = -21           // IFP common denominator
};
