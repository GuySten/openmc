  ...
  if (settings::photon_transport) {
    ...
    if (settings::electron_treatment == ElectronTreatment::TTB) {
      ...
      if (data::ttb_e_grid.size() >= 1) {
        ...
        data::energy_min[electron] = std::exp(data::ttb_e_grid(1));
        data::energy_max[electron] = std::exp(data::ttb_e_grid(n_e-1));
       
        data::energy_min[positron] = data::energy_min[electron];
        data::energy_max[positron] = data::energy_max[electron];
