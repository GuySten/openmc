...
IndependentSource::IndependentSource(pugi::xml_node node) : Source(node)
{
  ...
  if (check_for_node(node, "particle")) {
    ...
    if (temp_str == "neutron") {
      ...
      particle_ = ParticleType::proton;
      settings::proton_transport = true;
    } else if (temp_str == "deuteron") {
      particle_ = ParticleType::deuteron;
      settings::deuteron_transport = true;
    } else if (temp_str == "triton") {
      particle_ = ParticleType::triton;
      settings::triton_transport = true;
    } else if (temp_str == "helion") {
      particle_ = ParticleType::helion;
      settings::helion_transport = true;
    } else if (temp_str == "alpha") {
      particle_ = ParticleType::alpha;
      settings::alpha_transport = true;
    } else {
